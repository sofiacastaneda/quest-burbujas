...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR FileStream_t6342275F1C1E26F5EEB5AD510933C95B78A5DA26 * File_Open_mDCC1D72FFA8F33F33FE0C02C66CD53A4AA1DB19C (String_t* ___path0, int32_t ___mode1, const RuntimeMethod* method);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* AudioEncoding_ToString_m49630D1AF2CB7E63373CAB3B80F23F0B8FCAF596 (AudioEncoding_t1D0EA8A3078DCD19768CCABAB5722C62CF8A8D5C * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		*L_12 = *(int32_t*)UnBox(L_13);
		...
		String_t* L_16;
		L_16 = String_Format_m2CDD2A21AF2BCE3CE07D634645F9A61B4CB7D9B3(_stringLiteral8BF3768A048853CBDA2EB8478E42FD206D4D43CA, L_11, /*hidden argument*/NULL);
		return L_16;
	}
}
// System.Void Meta.WitAi.Data.AudioEncoding::.ctor()
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MicDebug_OnStartRecording_mB16675B2DD44A9A1955F4E650AF234B7B5B1800F (MicDebug_tFB7E58CC025A3889CEF9813EF4765EF94C383FDC * __this, const RuntimeMethod* method)
{
	...
	memset((&V_1), 0, sizeof(V_1));
	{
		...
		String_t* L_0;
		L_0 = Application_get_temporaryCachePath_m07E9ED87553AB46750FD4DF255F6B414368EB749(/*hidden argument*/NULL);
		V_0 = L_0;
		// path += "/" + fileDirectory;
		String_t* L_1 = V_0;
		String_t* L_2 = __this->get_fileDirectory_5();
		String_t* L_3;
		L_3 = String_Concat_mC41740F000A5A48F8D313FB4CEE0E35E207A2632(L_1, _stringLiteral86BBAACC00198DBB3046818AD3FC2AA10AE48DE1, L_2, /*hidden argument*/NULL);
		V_0 = L_3;
		// if (path.EndsWith("/"))
		String_t* L_4 = V_0;
		NullCheck(L_4);
...
IL_0035:
	{
		...
		String_t* L_10 = V_0;
		bool L_11;
		L_11 = Directory_Exists_m78C3C817343C9DA85628174C29EED1322C5D0FA1(L_10, /*hidden argument*/NULL);
		if (L_11)
		{
			goto IL_0044;
		}
	}
	{
		...
		L_13 = Directory_CreateDirectory_mD4AF617271FC2134CDC13A8D41D492BE477028E5(L_12, /*hidden argument*/NULL);
	}
...
IL_0044:
	{
		...
		L_14 = DateTime_get_Now_mDC71803EA6776DD66EA7477CDCCD62191726B478(/*hidden argument*/NULL);
		V_1 = L_14;
		...
		String_t* L_44;
		L_44 = String_Format_m2CDD2A21AF2BCE3CE07D634645F9A61B4CB7D9B3(_stringLiteral138C8DE2C1CB9DED85DB8AAFB49C1CF08A14A170, L_40, /*hidden argument*/NULL);
		V_0 = L_44;
		// Debug.Log("MicDebug - Writing recording to file: " + path);
		String_t* L_45 = V_0;
		String_t* L_46;
		L_46 = String_Concat_m10758B01687A2181C8727AD9FD9CCF5325C61C2A(_stringLiteral6BC7B8B30763D35752A71C9CA56135B797B57F9D, L_45, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Debug_tEB68BCBEB8EFD60F8043C67146DC05E7F50F374B_il2cpp_TypeInfo_var);
		Debug_Log_mF2A2ACB1738BA264EF07744AAF260BC5DDD2A11A(L_46, /*hidden argument*/NULL);
		// _fileStream = File.Open(path, FileMode.Create);
		String_t* L_47 = V_0;
		FileStream_t6342275F1C1E26F5EEB5AD510933C95B78A5DA26 * L_48;
		L_48 = File_Open_mDCC1D72FFA8F33F33FE0C02C66CD53A4AA1DB19C(L_47, 2, /*hidden argument*/NULL);
...
IL_023c:
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		bool L_93;
		L_93 = Object_op_Inequality_mDCB4E958808E725D0612CCABF340B284085F03D6(L_92, (Object_tF2F3778131EFF286AF62B7B013A170F95A91571A *)NULL, /*hidden argument*/NULL);
		if (!L_93)
		{
			goto IL_025d;
		}
