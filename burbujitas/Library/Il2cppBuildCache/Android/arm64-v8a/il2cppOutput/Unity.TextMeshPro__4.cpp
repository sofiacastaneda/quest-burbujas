...
IL_008c:
	{
		...
		int32_t L_44;
		L_44 = Mathf_Abs_m30D5BFC4824B78857BE4DCA90514A9DDDB076568(L_43, /*hidden argument*/NULL);
...
IL_0526:
	{
		...
		float L_212;
		L_212 = Time_get_deltaTime_mF558623BBB4EE65C8810243B05ED204A9E8D6FD1(/*hidden argument*/NULL);
...
IL_002e:
	{
		...
		NullCheck(L_5);
		UnityAction_t22E545F8BE0A62EE051C6A83E209587A0DB1C099 * L_6 = ((Graphic_tF07D777035055CF93BA5F46F77ED5EDFEFF9AE24 *)L_5)->get_m_OnDirtyVertsCallback_19();
		if (!L_6)
		{
			goto IL_004e;
		}
	}
	{
		...
		NullCheck(L_7);
		UnityAction_t22E545F8BE0A62EE051C6A83E209587A0DB1C099 * L_8 = ((Graphic_tF07D777035055CF93BA5F46F77ED5EDFEFF9AE24 *)L_7)->get_m_OnDirtyVertsCallback_19();
		NullCheck(L_8);
...
IL_004e:
	{
		...
		NullCheck(L_9);
		L_9->set_m_DelayedGraphicRebuild_301((Coroutine_t899D5232EF542CB8BA70AF9ECEECA494FAA9CCB7 *)NULL);
		// }
		return (bool)0;
	}
}
...
IL_002e:
	{
		...
		TextMeshProUGUI_tCC5BE8A76E6E9AF92521A462E8D81ACFBA7C85F1 * L_4 = V_1;
		NullCheck(L_4);
		((TMP_Text_t86179C97C713E1A6B3751B48DC7A16C874A7B262 *)L_4)->set_m_isMaterialDirty_53((bool)1);
		// CanvasUpdateRegistry.RegisterCanvasElementForGraphicRebuild(this);
		TextMeshProUGUI_tCC5BE8A76E6E9AF92521A462E8D81ACFBA7C85F1 * L_5 = V_1;
		IL2CPP_RUNTIME_CLASS_INIT(CanvasUpdateRegistry_t53CA156F8691B17AB7B441C52E0FB436E96A5D0B_il2cpp_TypeInfo_var);
		CanvasUpdateRegistry_RegisterCanvasElementForGraphicRebuild_m274722849A82887D5FD1EBC8F2880BF4A1E6D26C(L_5, /*hidden argument*/NULL);
		// if (m_OnDirtyMaterialCallback != null)
		TextMeshProUGUI_tCC5BE8A76E6E9AF92521A462E8D81ACFBA7C85F1 * L_6 = V_1;
		NullCheck(L_6);
		UnityAction_t22E545F8BE0A62EE051C6A83E209587A0DB1C099 * L_7 = ((Graphic_tF07D777035055CF93BA5F46F77ED5EDFEFF9AE24 *)L_6)->get_m_OnDirtyMaterialCallback_20();
		if (!L_7)
		{
			goto IL_0055;
		}
	}
	{
		...
		NullCheck(L_8);
		UnityAction_t22E545F8BE0A62EE051C6A83E209587A0DB1C099 * L_9 = ((Graphic_tF07D777035055CF93BA5F46F77ED5EDFEFF9AE24 *)L_8)->get_m_OnDirtyMaterialCallback_20();
		NullCheck(L_9);
...
IL_0055:
	{
		...
		NullCheck(L_10);
		L_10->set_m_DelayedMaterialRebuild_302((Coroutine_t899D5232EF542CB8BA70AF9ECEECA494FAA9CCB7 *)NULL);
		// }
		return (bool)0;
	}
}
...
{
	{
		...
		TMP_TextInfo_t33ACB74FB814F588497640C86976E5DB6DD7B547 * L_0 = __this->get_m_textInfo_153();
		return L_0;
	}
}
IL2CPP_MANAGED_FORCE_INLINE IL2CPP_METHOD_ATTR float TMP_TextElement_get_scale_m68BBDD7267D300D683D9D4EA518EF63776CA7AB4_inline (TMP_TextElement_tDF9A55D56A0B44EA4EA36DEDF942AEB6369AF832 * __this, const RuntimeMethod* method)
